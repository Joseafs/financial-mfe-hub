...
export default (env = {}, argv) => {
  ...
  return {
    ...
    output: {
      ...
      publicPath: 'auto',
      clean: true,
      uniqueName: `financial_mfe_dashboard_${release}`,
    },
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        templateContent: `<!doctype html><html><body style="background:#020617;color:#fff;font-family:system-ui"><h1>dashboard-mfe ${release} online</h1><p>Version <strong>${version}</strong> · port ${port}</p><p>Consume <code>remoteEntry.js</code> through the Shell.</p></body></html>`,
      }),
    ],
    devServer: {
      port,
