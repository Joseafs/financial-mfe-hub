...
export default (_env, argv) => ({
  ...
  output: {
    ...
    publicPath: 'auto',
    clean: true,
    uniqueName: 'financial_mfe_payments',
  },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      templateContent: '<!doctype html><html><body style="background:#020617;color:#fff;font-family:system-ui"><h1>payments-mfe remote online</h1><p>Consume <code>remoteEntry.js</code> through the Shell.</p></body></html>',
    }),
  ],
  devServer: {
    port: 4203,
